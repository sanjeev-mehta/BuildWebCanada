...
export default function TattooDemo() {
  ...
  return <main className="tattoo-demo">
    ...
    <footer className="ink-footer"><strong>NOCTURNE STUDIO</strong><span>Fictional tattoo studio · Vancouver, BC</span><small>© {new Date().getFullYear()} BuildWebCanada. All rights reserved.</small><Link to="/web-templates">Back to templates</Link></footer>
  </main>;
}
