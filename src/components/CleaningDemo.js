...
export default function CleaningDemo() {
  ...
  return <main className="cleaning-demo">
    ...
    <section className="clean-hero"><img src={office} alt="Bright modern office" fetchPriority="high" /><div className="clean-veil"></div><div className="clean-hero-content"><p>Care for your space, made simple</p><h1>A cleaner space.<br /><i>A clearer day.</i></h1><a href="#estimate">Get a free estimate <span>→</span></a></div></section>
    ...
    <footer className="clean-footer"><span>BRIGHTSPACE</span><p>Sample business · Vancouver, BC · (604) 555-0128</p><Link to="/web-templates">Back to templates</Link></footer>
  </main>;
}
