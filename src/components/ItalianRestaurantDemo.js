...
export default function ItalianRestaurantDemo() {
  ...
  return <main className="italian-demo">
    ...
    <section className="italian-hero"><img src={banner} alt="Italian dining table" fetchPriority="high" /><TemplateHeroMotion variant="italian" /><div className="italian-hero-copy"><p>Italian cucina · Vancouver</p><h1>Gather around<br />the <i>table.</i></h1><a href="#menu">Discover our menu</a></div></section>
    ...
    <footer className="italian-footer"><strong>VIA LUNA</strong><span>Sample restaurant · 47 Moonlight Avenue · Vancouver</span><small>© {new Date().getFullYear()} BuildWebCanada. All rights reserved.</small><Link to="/web-templates">Back to templates</Link></footer>
  </main>;
}
