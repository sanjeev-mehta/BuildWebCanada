...
export default function ConstructionDemo() {
  ...
  return <main className="construction-demo">
    ...
    <section className="build-hero"><img src={hero} alt="Original contemporary construction site" fetchPriority="high" /><div className="build-overlay"></div><TemplateHeroMotion variant="construction" /><div className="build-hero-copy"><p>Design · Build · Deliver</p><h1>Built with<br /><i>intention.</i></h1><a href="#contact-build">Discuss your project <span>↗</span></a></div><div className="build-coordinates">49° 16' N&nbsp;&nbsp; 123° 07' W</div></section>
    ...
    <footer className="build-footer"><strong>FOUND / FORM</strong><span>Fictional studio · Vancouver, BC</span><small>© {new Date().getFullYear()} BuildWebCanada. All rights reserved.</small><Link to="/web-templates">Back to templates</Link></footer>
  </main>;
}
