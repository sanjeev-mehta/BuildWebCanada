...
export default function RestaurantDemo() {
  ...
  return (
    <main className="restaurant-demo">
      ...
      <footer className="restaurant-footer"><span>URBAN BITES</span><p>1250 Main Street · Vancouver, BC · (604) 555-0182</p><Link to="/web-templates">Back to templates</Link></footer>
    </main>
  );
}
